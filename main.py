...
def GetUserJson(deptId,text,stuNum,userName,RuleId,templateid):
    ...
    return  {
        ...
        "areaStr": {"streetNumber":"","street":"林山寨街道","district":"中原区","city":"郑州市","province":"河南省","town":"","pois":"河南工业大学(嵩山路校区)","lng":113.2031809999795 + random.random()/1000,"lat":34.74250116238093 + random.random()/1000,"address":"中原区林山寨街道嵩山南路142号河南工业大学(嵩山路校区)","text":"河南省-郑州市","code":""},
